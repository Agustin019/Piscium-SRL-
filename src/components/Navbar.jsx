        ...
        <div className="md:flex items-center justify-between  md:py-4 py-6 md:px-10 px-7">
          ...
          <ul className={`md:flex md:items-center md:pb-0 pb-12 bg-black absolute md:static  
            ...
            <li className='md:ml-8 text-lg md:my-0 my-7' >
              <Link
                to='/'
                className={`${location.pathname === '/' ? 'text-gray-500' : 'text-white'} hover:text-gray-500 duration-500 font-semibold `}
              >Inicio</Link>
            </li>
            <li className='md:ml-8 text-lg md:my-0 my-7' >
              <Link
                to='/productos'
                className={`${location.pathname === '/productos' ? 'text-gray-500' : 'text-white'} hover:text-gray-500 duration-500 font-semibold `}>
                Ver Productos</Link>
            </li>
            <li className='md:ml-8 text-lg md:my-0 my-7' >
              <Link
                to='/nosotros'
                className={`${location.pathname === '/nosotros' ? 'text-gray-500' : 'text-white'} hover:text-gray-500 duration-500 font-semibold `}>
               Nosotros</Link>
            </li>
          </ul>
